...
namespace _19.Filtering_Data_in_Dataview
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            EmployeesDataView.RowFilter = "Country = 'KSA' or Country = 'USA'";
            Console.WriteLine("\n\nEmployees List from DataView where country is KSA or USA\n");
            for (byte i = 0; i < EmployeesDataView.Count; i++)
            {
                Console.WriteLine($"{EmployeesDataView[i][0]}, {EmployeesDataView[i][1]}, {EmployeesDataView[i][2]}, {EmployeesDataView[i][3]}");
            }
